...
Get-DbaPfDataCollectorSet -CollectorSet 'PAL - SQL Server 2014 and Up' | Invoke-DbaPfRelog | Update-DbaPowerBiDataSource
Get-DbaPfDataCollectorSet -CollectorSet 'PAL - SQL Server 2014 and Up' | Invoke-DbaPfRelog -AllowClobber | Select -Expand FullName | Invoke-Item
...
Get-DbaXESession -SqlInstance sql2016 -Session 'Long Running Queries' | Read-DbaXEFile | Update-DbaPowerBiDataSource
Start-DbaPowerBi